...
/**
 * Servlet implementation class RedirigirPaginaALibro
 */
@WebServlet("/RedirigirPagina")
public class RedirigirPagina extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RedirigirPagina() {
        super();
