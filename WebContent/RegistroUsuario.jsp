...
<input type="text" name="aNombreYApellido" placeholder="Tu nombre y apellido *" required>
<input type="text" name="aDni" placeholder="Tu dni*" required>
...
<input type="password" name="aContraseña" placeholder="contraseña *" required>
</fieldset>
